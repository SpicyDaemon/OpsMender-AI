...
* [AI Incident Memory](memory-guide.md) — *Sprint 45, in progress.* How OpsMender carries lessons across incidents, the `recall` / `remember` workflow nodes, auto-compaction, the operator thumbs-up/down loop, and what is and isn't remembered.
