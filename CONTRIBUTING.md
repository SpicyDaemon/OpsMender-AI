# Contributing to AI Incident Manager

Thanks for your interest in AIM. This guide covers the local setup, the test loop, and how we review pull requests.
...
AIM has a Python backend (FastAPI + LangGraph) and a Next.js static export for the dashboard.
...
AIM has a few deliberate invariants — please read [docs/REFERENCE.md](docs/REFERENCE.md) before proposing changes in these areas:
