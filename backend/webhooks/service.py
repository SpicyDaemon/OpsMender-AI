...
def _build_notification_text(payload: dict[str, Any]) -> str:
    ...
    if "session" not in payload:
        ...
        return f"Opsmender {event_label}: {msg}"
    ...
    return (
        f"Opsmender {event_label}: {incident_title} "
        ...
        blocks = [
            {
                ...
                "text": {
                    "type": "mrkdwn",
                    "text": f"*Opsmender {_event_label(payload['event'])}*\n{text}",
                },
            }
        ]
    ...
    *,
    ...
    payload = {
        ...
        "session": {
            ...
            "model_id": "test",
            "status": "completed",
            "summary": "Webhook test payload from Opsmender.",
        ...
        "incident": {
            ...
            "description": "Generated by Opsmender when testing an outbound trigger.",
            "status": "open",
            "severity": "medium",
            "external_id": None,
