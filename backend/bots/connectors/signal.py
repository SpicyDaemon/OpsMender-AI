...
class SignalAdapter:
    ...
    outbound webhooks. AIM expects a reverse proxy / relay in front of
    the bridge that injects an ``X-AIM-Webhook-Secret`` header matching
    ...
    def verify_webhook(
        ...
        *,
        ...
        provided = headers.get("x-aim-webhook-secret") or headers.get(
            "X-AIM-Webhook-Secret"
        )
