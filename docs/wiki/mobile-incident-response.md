...
- `/dashboard/config`, AI Agent setup pages (`/dashboard/models`, `/dashboard/mcp-servers`, `/dashboard/workflows`), and advanced setup aliases such as `/dashboard/ingest-tokens` — operator setup, not a runtime path.
