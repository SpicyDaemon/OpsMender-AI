...
const NAVIGATE_ITEMS: Omit<CommandItem, "kind">[] = [
  ...
  { id: "n-notifications", label: "Paging — My Notifications", icon: Bell, href: "/dashboard/paging/my-notifications" },
  ...
  { id: "n-bot-connectors", label: "Integrations — Bot Connectors", icon: Plug, href: "/dashboard/bot-connectors" },
  { id: "n-webhooks", label: "Integrations — Webhook Triggers", icon: Send, href: "/dashboard/webhooks" },
  { id: "n-ingest", label: "Integrations — Ingest Tokens", icon: Inbox, href: "/dashboard/ingest-tokens" },
