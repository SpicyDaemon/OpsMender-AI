...
const NAVIGATE_ITEMS: Omit<CommandItem, "kind">[] = [
  ...
  { id: "n-priority-rules", label: "Paging — Priority Rules", icon: ListOrdered, href: "/dashboard/paging/priority-rules" },
  ...
  { id: "n-notification-channels", label: "Paging — Notification Channels", icon: Plug, href: "/dashboard/paging/notification-channels", keywords: "slack teams discord email sms telegram whatsapp signal bot connectors" },
  { id: "n-notifications", label: "Paging — My Notifications", icon: Bell, href: "/dashboard/paging/my-notifications", keywords: "personal preferences" },
  { id: "n-outbound-hooks", label: "Paging — Outbound Hooks", icon: Send, href: "/dashboard/paging/outbound-hooks", keywords: "webhook triggers lifecycle external systems stakeholders" },
